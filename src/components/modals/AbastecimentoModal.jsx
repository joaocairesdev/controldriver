...
export default function AbastecimentoModal({ aberto, onClose, veiculosPermitidos = null }) {
  ...
  function textoContaCartao() {
    if (isCredito) return cartaoSelecionado ? `${cartaoSelecionado.nome} final ${cartaoSelecionado.final_cartao}` : "Selecionar cartão";
  ...
  return (
    <>
      <ModalBase aberto={aberto} titulo="Novo Abastecimento" descricao="Registre combustível e atualize km/odômetro do veículo." onClose={onClose} largura="max-w-5xl">
