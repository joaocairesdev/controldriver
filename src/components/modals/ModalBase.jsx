...
export default function ModalBase({
  ...
  return (
    <div
      className={`fixed inset-0 bg-black/70 flex items-end sm:items-center justify-center ${z} overscroll-none`}
    >
      <div
...
{acaoCabecalho}
        ...
        <div
          ...
          className="flex-1 min-h-0 overflow-y-auto overscroll-contain touch-pan-y scrollbar-hide p-5 sm:p-6"
